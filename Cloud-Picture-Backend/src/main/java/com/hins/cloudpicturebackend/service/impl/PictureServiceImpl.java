...
import com.hins.cloudpicturebackend.api.aliyunai.AliYunAiApi;
import com.hins.cloudpicturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.hins.cloudpicturebackend.manager.CosManager;
import com.hins.cloudpicturebackend.manager.FileManager;
...
import com.hins.cloudpicturebackend.manager.upload.UrlPictureUpload;
import com.hins.cloudpicturebackend.mapper.PictureMapper;
...
import com.hins.cloudpicturebackend.model.enums.PictureReviewStatusEnum;
...
import com.hins.cloudpicturebackend.utils.ColorSimilarUtils;
import com.hins.cloudpicturebackend.utils.ColorTransformUtils;
...
//            }
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        for (Element imgElement : imgElementList) {
            ...
            // github.com/HinsCoder?tab=repositories，应该只保留 github.com
...
//        checkPictureAuth(loginUser, picture);
        ...
        // API要求图像分辨率不低于512×512像素且不超过4096×4096像素
