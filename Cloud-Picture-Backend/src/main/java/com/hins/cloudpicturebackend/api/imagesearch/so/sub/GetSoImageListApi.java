package com.hins.cloudpicturebackend.api.imagesearch.so.sub;
...
public class GetSoImageListApi {
    ...
    public static void main(String[] args) {
        List<SoImageSearchResult> imageList = getImageList("https://p2.ssl.qhimgs1.com/bdr/468_250_/t029a2ee84e02bc18a2.jpg", 0);
